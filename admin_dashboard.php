...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($habitats as $habitat): ?>
                <tr>
                    <td><img src="<?= htmlspecialchars($habitat['image']); ?>" alt="<?= htmlspecialchars($habitat['name']); ?>" width="100"></td>
                    ...
                    <td>
                        ...
                        <a href="delete_habitat.php?id=<?= $habitat['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet habitat ?')">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    ...
    <a href="edit_animal.php">Ajouter un Animal</a>
    <table>
        <thead>
            <tr>
                <th>Image</th>
        ...
        <tbody>
            <?php foreach ($animals as $animal): ?>
                <tr>
                    <td><img src="<?= htmlspecialchars($animal['image']); ?>" alt="<?= htmlspecialchars($animal['name']); ?>" width="100"></td>
                    <td><?= htmlspecialchars($animal['name']); ?></td>
                    <td><?= htmlspecialchars($animal['species']); ?></td>
                    <td><?= htmlspecialchars($animal['habitat']); ?></td>
                    <td>
                        <a href="edit_animal.php?id=<?= $animal['id']; ?>">Modifier</a> |
                        <a href="delete_animal.php?id=<?= $animal['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet animal ?')">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
